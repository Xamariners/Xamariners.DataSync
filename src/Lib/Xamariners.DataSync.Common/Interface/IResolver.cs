...
namespace Xamariners.DataSync.Common.Interface
{
    public interface IResolver
    {
        ...
        void Register<TInterface, TImplementation>(
            LifetimeScopeEnum lifetimeScope = LifetimeScopeEnum.InstancePerDependency);

        void Register<TInterface>(LifetimeScopeEnum lifetimeScope = LifetimeScopeEnum.InstancePerDependency);

        void RegisterMultiple<TImplementation>(LifetimeScopeEnum lifetimeScope, params Type[] interfaces)
